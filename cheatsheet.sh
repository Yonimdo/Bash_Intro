...
#Link to OP: https://gist.github.com/LeCoupa/122b12050f5fb267e75f
...
CTRL+D  # similar to exit with log or delete one character
...
fg <job>                 # allow us to bypass any shell aliases that artificially set a maximum count on the command
